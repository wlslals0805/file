 ...
 <div class="container w-500">
            ...
            <div class="row left">
                ...
                <div class="row left">
                    ...
                    <input type="text" name="memberPost" placeholder="우편번호" style="width: 8em;" class="form-input">
                    ...
                    <input type="text" name="memberAddr1" placeholder="상세주소" class="form-input w-100 mt-10">
