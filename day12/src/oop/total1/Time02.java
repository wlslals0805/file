...
//	4000초 - 1시간 10분
	...
	public int getSecond() {
		return second+this.getHour()+this.getMinute();
	}
...
//	}
	...
	public void show() {
		...
		System.out.println(this.getRhour()+"시간");
		System.out.println(this.getRminute()+"분");
		System.out.println(this.getRsecond()+"초");
	}
}
